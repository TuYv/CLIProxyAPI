...
func (r *UsageReporter) PublishAdditionalModel(ctx context.Context, model string, detail usage.Detail) {
	...
	r.publishRecord(ctx, r.withAccountMetadata(ctx, record))
}
...
func (r *UsageReporter) SetTranslatedReasoningEffort(payload []byte, format string) {
	...
	if serviceTier := extractServiceTierFromPayload(payload); serviceTier != "" {
...
func (r *UsageReporter) publishWithOutcome(ctx context.Context, detail usage.Detail, failed bool, fail usage.Failure) {
	...
	detail = normalizeUsageDetailTotal(detail)
	r.once.Do(func() {
		r.publishRecord(ctx, r.buildRecordFromContext(ctx, detail, failed, fail))
	})
}
...
func (r *UsageReporter) EnsurePublished(ctx context.Context) {
	...
	r.once.Do(func() {
		r.publishRecord(ctx, r.buildRecordFromContext(ctx, usage.Detail{}, false, usage.Failure{}))
	})
}
